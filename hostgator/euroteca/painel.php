  ...
  <main class="login">
    <div class="login__container">
      ...
      <form class="login__form">
        <a href="inserir.php" class="login__input">INSERIR</a>
        <br>
        <a href="lista.php" class="login__input">ALTERAR/EXCLUIR</a>
        <br>
        <a href="emprestimos.php" class="login__input">EMPRÉSTIMOS</a>
        <br>
